...
public class CustomSetupApplication extends SetupApplication {
	...
	public CustomSetupApplication(InfoflowAndroidConfiguration config, Set<String> stringSourcesSigs, 
	...
	protected void parseAppResources() throws IOException, XmlPullParserException {
		...
		entryPointCreator = new CustomAndroidEntryPointCreator(manifest, this.entrypoints);
	}
	*/
	
	@Override
	public ISourceSinkManager createSourceSinkManager(LayoutFileParser lfp,
		...
		AccessPathBasedSourceSinkManager sourceSinkManager2 = new CustomAccessPathBasedSourceSinkManager(sources, sinks,
				callbacks, infoflowAndroidConfiguration, userControlsByID, this.stringSourcesSigs, 
				this.fieldSourceSigs, this.stmtSourceSigs);
